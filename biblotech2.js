...
function updateIconColors(theme) {
    ...
    icons.forEach(icon => {
        icon.style.fill = theme === 'light' ? '#333333' : '#ffffff';
    });
}
...
function displayMockSearchResults() {
    ...
    searchResults.innerHTML = `
        <div class="search-result">
            <input type="checkbox" value="paper1">
            <div>
                <h3>Sample Research Paper 1</h3>
                <p>Authors: John Doe, Jane Smith</p>
                <p>Year: 2023</p>
                <p>Source: Journal of Advanced Research</p>
                <div class="result-actions">
                    <button onclick="addToBibliography('paper1')">Add to Bibliography</button>
                    <button onclick="generateCitation('paper1')">Generate Citation</button>
                </div>
            </div>
        </div>
        <div class="search-result">
            <input type="checkbox" value="paper2">
            <div>
                <h3>Sample Research Paper 2</h3>
                <p>Authors: Alice Johnson, Bob Williams</p>
                <p>Year: 2022</p>
                <p>Source: International Conference on AI</p>
                <div class="result-actions">
                    <button onclick="addToBibliography('paper2')">Add to Bibliography</button>
                    <button onclick="generateCitation('paper2')">Generate Citation</button>
                </div>
            </div>
        </div>
    `;
...
document.getElementById('searchExecuteBtn').addEventListener('click', displayMockSearchResults);

// Event listener for search input
document.getElementById('searchTerms').addEventListener('input', function() {
    if (this.value.length > 0) {
        document.getElementById('searchResults').innerHTML = '<p>Type and click search to see results...</p>';
    } else {
